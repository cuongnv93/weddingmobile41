  ...
  function (t, e, n) {
    ...
    var r = n(2),
      ...
      c = function (t, e, n) {
        ...
        var o = t + "=" + e + ";" + ("expires=" + r.toUTCString()) + ";path=/";
        document.cookie = o;
      },
      u = function (t) {
        for (
          var e = {}, n = document.cookie.split(";"), r = 0;
          r < n.length;
          r++
        ) {
      ...
      s = function (t, e) {
        ...
        return (
          ...
          (n.height = "1"),
          (n.src =
            "".concat("https://a.pancake.vn", "/").concat(t, "?") + (e || "")),
    ...
    function l() {
      try {
        ...
        return (
          ...
          (e.fillStyle = "#069"),
          e.fillText("fingerprint-test", 2, 15),
          (e.strokeStyle = "rgba(120, 186, 176, 0.8)"),
          e.strokeText("fingerprint-test", 2, 15),
          t.toDataURL()
        );
      } catch (t) {
        return "canvas_na";
    ...
    function f() {
      try {
        ...
        if (!e) return "webgl_na";
        var n = e.getExtension("WEBGL_debug_renderer_info");
        return (
          (n ? e.getParameter(n.UNMASKED_VENDOR_WEBGL) : "unknown") +
          "||" +
              ...
              for (;;)
                switch ((t.prev = t.next)) {
                  case 0:
                    return (
                      (t.prev = 0),
                      (e = new (window.OfflineAudioContext ||
                        window.webkitOfflineAudioContext)(1, 44100, 44100)),
                      ((n = e.createOscillator()).type = "triangle"),
                      (n.frequency.value = 1e4),
                      (r =
                        e.createDynamicsCompressor()).threshold.setValueAtTime(
                        -50,
                        e.currentTime
                      ),
                      r.knee.setValueAtTime(40, e.currentTime),
                      r.ratio.setValueAtTime(12, e.currentTime),
                      r.attack.setValueAtTime(0, e.currentTime),
                      r.release.setValueAtTime(0.25, e.currentTime),
                      n.connect(r),
                  ...
                  case 16:
                    for (
                      o = t.sent, i = o.getChannelData(0), c = 0, u = 0;
                      u < i.length;
                      u += 100
                    )
                      c += Math.abs(i[u]);
                    return t.abrupt("return", c.toString());
                  case 23:
                    return (
                      (t.prev = 23),
                      (t.t0 = t.catch(0)),
                      t.abrupt("return", "audio_na")
                    );
                  case 26:
                  case "end":
                    return t.stop();
              ...
              switch ((t.prev = t.next)) {
                case 0:
                  return (
                    ...
                    (i = "".concat(screen.width, "x").concat(screen.height)),
                    (c = screen.colorDepth),
                    (u = Array.from(navigator.plugins || [])
                      .map(function (t) {
                        return t.name;
                      })
                      .join(",")),
                    (s = navigator.hardwareConcurrency || 0),
                    (d = navigator.deviceMemory || 0),
  ...
  function (t, e, n) {
    ...
    new ((function () {
      function t(e) {
        ...
        for (var n = e.q || [], r = 0; r < n.length; r++)
          "init" == n[r][0] &&
            ((this.trackingId = n[r][1]),
            n[r][2] && n[r][2].tz && (this.tz = n[r][2].tz));
      }
      return (
        u()(t, [
          {
            key: "newWebcakeCollection",
            value: function () {
              Object(l.b)().then(function (t) {
                var e = sessionStorage.getItem("__session_id__");
                e ||
                  ((e = Object(s.a)()),
                  sessionStorage.setItem("__session_id__", e));
                var n = {
                  p:
                    WebcakeScript.CONST.PAGE_ID ||
                    document.documentElement.getAttribute("x:id"),
                  ...
                  fp: t,
                  sid: e,
                  cp_id: window.P_CAMPAIGN_ID,
                  cp_vid: window.P_CAMPAIGN_VARIANT_ID,
                };
                ...
                Object(l.a)("webcake_collection", r);
              });
            },
          },
          {
            ...
            value: function () {
              if (this.trackingId) {
                ...
                var o =
                  ...
                  "&tid=" +
                  encodeURIComponent(this.trackingId) +
                  "&ts=" +
                  Date.now() +
                  "&_v=" +
                  ...
                  Object(l.c)("_abt") +
                  "&campaign_id=" +
                  (window.P_CAMPAIGN_ID || null) +
                  "&campaign_variant_id=" +
                  (window.P_CAMPAIGN_VARIANT_ID || null);
                this.tz && (o += "&tz=" + this.tz),
                  window.ab_pv_event_fired || Object(l.a)("collect", o),
