        ...
        (_.prototype = {
          ...
          finish: function (t) {
            for (var r = this.tryEntries.length - 1; r >= 0; --r) {
              ...
              if (e.finallyLoc === t)
                return this.complete(e.completion, e.afterLoc), L(e), s;
            }
          },
          catch: function (t) {
            for (var r = this.tryEntries.length - 1; r >= 0; --r) {
                ...
                case 0:
                  return (
                    ...
                    (u = Array.from(navigator.plugins || [])
                      ...
                      .join(",")),
                    (f = navigator.hardwareConcurrency || 0),
                    (s = navigator.deviceMemory || 0),
                    ...
                    (y = navigator.connection || {}),
                    (g = y.effectiveType || "unknown"),
                    (m = y.downlink || 0),
                    (w = [r, e, n, o, i, c, u, f, s, l, h, p, v, d, g, m].join(
                      "||"
                    )),
                    (x = new TextEncoder()),
                    (b = x.encode(w)),
